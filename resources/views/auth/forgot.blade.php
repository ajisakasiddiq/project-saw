...
<head>
    ...
    <title>Lupa Sandi | SPK-AHP</title>
                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Lupa Sandi</h1>
                                            ...
                                            <i class="fas fa-info-circle text-blue"></i> Masukkan email untuk reset sandi
                                        </div>
                                    </div>
                                    @include('template/alert')
                                    <form class="user needs-validation" action="{{ route('lupa-sandi') }}" method="post">
                                        @csrf
