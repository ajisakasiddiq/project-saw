...
@section('title', 'Edit Kriteria | SPK-AHP')
{{-- @endsection --}}
@section('content')
    ...
    <!-- Judul Halaman -->
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                @foreach ($kt as $item)
                <form class="needs-validation" method="POST" action="/editkt/{{$item->id}}">
                    @csrf
                    <div class="form-group">
                        <label for="nama_kriteria">Nama Kriteria</label>
                        <input 
                            type="text" 
                            class="form-control form-control-user @error('nama_kriteria') is-invalid @enderror" 
                            id="nama_kriteria" 
                            name="nama_kriteria" 
