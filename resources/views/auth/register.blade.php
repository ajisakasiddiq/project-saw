                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user needs-validation" action="{{ route('registrasi') }}" method="post">
                                        @csrf
                                        <div class="form-group">
                                            <input autocomplete="off" type="text" class="form-control form-control-user @error('nim') is-invalid @enderror" id="nim" placeholder="Nomor Induk Mahasiswa (NIM)" max="9" name="nim"/>
                                            @error('nim')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            <input autocomplete="off" type="email" class="form-control form-control-user @error('email') is-invalid @enderror" id="input" placeholder="Email" name="email" />
                                            @error('email')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input autocomplete="off" type="password" class="form-control form-control-user @error('cpassword') is-invalid @enderror" id="sandi" name="cpassword" placeholder="Ulangi Sandi" />
                                                @error('cpassword')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
