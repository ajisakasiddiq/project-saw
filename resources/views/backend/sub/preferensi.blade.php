...
@section('title', 'Data Sub | SPK-AHP')
{{-- @endsection --}}
@section('content')
                <!-- Awal Konten -->
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Prefensi Bobot Sub Kriteria</h1>
                    ...
                    <div class="card shadow d-flex justify mb-4">
                        <div class="card-header py-3">
                            <a href="/sub" class="btn btn-dark m-1 btn-icon-text btn-rounded">
                        ...
                        <form action="/preferensisb/{{$id}}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="user" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th class="text-right" width="25%">Nama Sub Kriteria</th>
                                            <th class="text-center" width="50%">Skala Perbandingan</th>
                                            <th class="text-left" width="25%">Nama Sub Kriteria</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        foreach ($sub as $row1) :
                                            ...
                                            foreach ($sub as $row2) :
                                                if ($i < $ii) :
                                                    $nilai = $sub_ahp[$row1->id][$row2->id];
                                        ?>
                                                    <tr>
                                                        <td class="text-right">{{$row1->nama_sub}}</td>
                                                        ...
                                                        <td class="text-left">{{$row2->nama_sub}}</td>
                                                    </tr>
                                        <?php
                                                    $no++;
                                                endif;
